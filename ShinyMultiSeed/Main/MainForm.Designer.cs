namespace ShinyMultiSeed
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            m_Gen4ResultLabel.Location = new Point(368, 13);
            m_Gen4ResultLabel.Name = "m_Gen4ResultLabel";
            m_Gen4ResultLabel.Size = new Size(205, 15);
            m_Gen4ResultLabel.TabIndex = 23;
            m_Gen4ResultLabel.Text = "条件を設定して計算ボタンを押してください";
            // 
            ...
            m_Gen4ResultDataGridView.Size = new Size(451, 369);
